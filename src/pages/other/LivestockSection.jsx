...
const LivestockCard = memo(({ item, handleSmoothScroll, isMobile, isTablet }) => {
  const cardStyle = {
    ...
    minHeight: isMobile ? "400px" : "450px", // Ensure consistent card height
  };
  ...
  const imageContainerStyle = {
    position: "relative",
    width: "100%",
    maxHeight: isMobile ? "200px" : "300px", // Limit max height to prevent overly tall images
    overflow: "hidden",
    display: "flex",
  ...
  const imageStyle = {
    ...
    maxWidth: "100%",
    maxHeight: isMobile ? "200px" : "300px", // Ensure image fits within max height
    ...
    >
      ...
      <div style={imageContainerStyle}>
        <img
          ...
          loading="lazy"
          onError={(e) =>
            (e.target.src = `/placeholder.svg?height=300&width=400&text=${encodeURIComponent(item.title)}`)
          }
        />
...
const LivestockSection = () => {
  ...
  const filteredLivestock =
    selectedCategory === "all" ? livestock : livestock.filter((item) => item.category === selectedCategory);
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible">
          <motion.div variants={itemVariants} style={headerStyle}>
            ...
            <p style={descriptionStyle}>
              Discover our premium collection of healthy, well-bred livestock. Each animal is carefully selected,
              vaccinated, and ready for farming, trading, or festive occasions.
            </p>
          </motion.div>
              ...
              {[
                {
                  step: "1",
                  title: "Browse & Select",
                  desc: "Choose from our quality livestock collection",
                  icon: "👀",
                },
                ...
                { step: "3", title: "Secure Payment", desc: "Make payment through our secure methods", icon: "💳" },
                {
                  ...
                  desc: "Arrange pickup or delivery with our support",
                  icon: "🚛",
                },
              ].map((item, index) => (
